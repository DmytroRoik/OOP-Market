...
var $imgTooltip = document.getElementsByClassName('tooltip')[0];
...
function createCartItemTemplate(item, index) {
    ...
    $li.addEventListener('mousemove', function(e) {
        ...
        $imgTooltip.style.top = e.clientY + document.documentElement.scrollTop + 'px';
        $imgTooltip.style.left = e.clientX + 'px';
